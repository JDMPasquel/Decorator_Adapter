...
public class GUIFood extends javax.swing.JFrame {
     ...
     */
    private void addFood(int id, String name, FoodTypeEnum type) throws Exception {
        Food food = new CapitalFood(id, name, type);

        //Fija el comando del invoker
        invoker.setCommand(new CreateCommand(new CryptFood(food.getId(), food.getName(), food.getType())));
        //Ejecuta el comando
        invoker.execute();
    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        Food capitalFood = new CapitalFood(id, name, foodTpye);
        Food food = null;
        try {
            food = new CryptFood(capitalFood.getId(), capitalFood.getName(), capitalFood.getType());
        } catch (Exception ex) {
            Logger.getLogger(GUIFood.class.getName()).log(Level.SEVERE, null, ex);
        }
